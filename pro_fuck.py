...
def method(fo):
    ...
    with tred(max_workers=spd) as ___TOXIC___:
        ...
        for user in fo:
            ...
            passlist = plist
            if method in ['1','01']:
                ___TOXIC___.submit(api,ids,names,passlist,total_ids)
            elif method in ['3','03']:
                ___TOXIC___.submit(api3,ids,names,passlist,total_ids)
            elif method in ['4','04']:
                ___TOXIC___.submit(api4,ids,names,passlist,total_ids)
            else:
                ___TOXIC___.submit(api2,ids,names,passlist,total_ids)
    print('\x1b[38;5;46m')
    linex()
