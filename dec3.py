...
time.sleep(0.05)
os.system("clear")
os.system("xdg-open https://wa.me/+17329649243?text=Assalamualaikum+makasih+bang+nangg+SC+nya+moga+ijo😎+Keynya+apa+abang+ganteng")
print(f"\n \x1b[1;97m ➢ \x1b[1;92mSebelum Masuk Ke Dan Tidak Tau Key nya Hubungi Admin")
input(f"\n\x1b[1;97m ➢ Klik [\x1b[1;92mEnter\x1b[1;97m]")
Password = "NANGG29" # --> Data Req Api key --> open_kt(life)("NANGG29")
